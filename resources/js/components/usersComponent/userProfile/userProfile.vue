                    ...
                    <div class="card-body" style="border:2px solid #f7931e;border-radius:5px;border-top:transparent;">
                        ...
                        <form action="{{ route('updateUserProfile')}}" method="post">
                            ...
                            <div class="px-lg-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn mt-4 mb-3 text-white" style="background:#f7931e;padding:10px 45px 35px;">{{ __('Save') }}</button>
                                </div>
                            </div>
                        </form>
                        <hr class="m-4">
                        <form method="post" action="{{ route('admin.profile.password') }}" autocomplete="off">
                            ...
                            <div class="px-lg-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn mt-4 mb-4 text-white" style="background:#f7931e;padding:10px 45px 35px;">{{ __('Change password') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>

    ...
    <div class="row">
      <div class="col-sm-3">
        ...
        <div class="text-center" style="padding-top: 80px;">
          <img
            :src="'/uploads/avatar/'+userInfo.avatar"
      ...
      <div class="col-sm-9">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="home">
            <hr />
            <form class="form" action="/users/profile">
              ...
              <div class="form-group">
                <div class="col-xs-12">
                  ...
                  <button class="btn btn-lg btn-success" type="submit">
                    <i class="glyphicon glyphicon-ok-sign"></i> Account Settings
                  </button>

...
@section('content')
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-header bg-dark">
                            ...
                            <div class="card-body bg-dark align-items-center text-center border-top" style="border-radius:7px !important;">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{route('franchise.setting.logo')}}" method="POST" enctype="multipart/form-data" id="logoForm">
                                            @csrf
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        @if($sidebar==1)
                            ...
                            <form method="post" action="{{ route('franchise.setting.basicColor') }}" autocomplete="off">
                                @csrf
                                <div class="card-body bg-dark align-items-center text-center border-top" style="border-radius:7px !important;">
                                    <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        @if($sidebar==1)
                            ...
                            <form method="post" action="{{route('franchise.setting.gradientColor')}}" autocomplete="off">
                                @csrf
                                <div class="card-body bg-dark align-items-center text-center border-top" style="border-radius:7px !important;">
                                    <div class="row">
    ...
    <script>
        function godark(val){
            if(val==1){
                Cookies.set('godarkFran',1);
            }
            else if(val==0){
                Cookies.set('godarkFran',0);
            }
            let URL = '<?php echo URL::to('/') ?>';
            let token = '<?php echo csrf_token() ?>';
            $.ajax({
                type: 'GET',
                url: `${URL}/franchise/setting/godark`,
                data: { _token: token ,dark:val},
                success:function(data) {
                    console.log(data);
                    window.location.href = `${URL}/franchise/setting`;
                },
        ...
        $(document).ready(function(){
            $godarkVal = Cookies.get('godarkFran');

...
@section('content')
    @include('admin.users.partials.header', ['title' => __('Edit Ads')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        {{-- <form method="post" action="{{ route('products.update', $ad) }}" autocomplete="off"> --}}
                        {{-- <form method="post" action="{{ route('products.update',$ad->id) }}" autocomplete="off" enctype="multipart/form-data"> --}}
                        <form method="post" action="{{ route('ads.update',$ad->id) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            @method('put')

                            <h6 class="heading-small text-muted mb-4">{{ __('ad information') }}</h6>
                            <div class="pl-lg-4">
                                {{-- upload img --}}
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{asset( 'uploads/ads_image/' . $ad->image )}}" id='img-upload' class="img-thumbnail rounded mx-auto d-block"/>
                                </div>
                                {{-- code and name input --}}
                                <div class="col-sm-12">
